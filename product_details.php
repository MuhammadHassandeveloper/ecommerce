   ...
   ?>
        ...
        <div class="single_product">
            ...
            <div class="container">
             ...
             $id=$_GET['id'];
                     $name=$_GET['name'];
          $query="SELECT categories.cat_name,sub_categories.sub_name , products.* FROM  ((categories inner join products on products.cat_id=categories.cat_id)inner join sub_categories on products.sub_id=sub_categories.sub_id)  WHERE pro_name ='$name'&& p_id='$id'";
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 order-3 mt-5">
                        <div class="product_description">
                            <div class="product_category mt-2"><?php echo$data['cat_name']  ?>
                                ><?php echo$data['sub_name']  ?> </div>
