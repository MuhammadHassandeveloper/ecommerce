...
$result=mysqli_query($connection, $sql);
    foreach ($result as $row) {?>
                <div class="table-wrapper">
                    <form method="post" action="coupon_controller.php?action=edit">
                        <div class="modal-body pd-20">

                            <div class="form-group">
                                <input type="hidden" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" value="<?php echo $row['id']?>" name="id">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Coupon Code</label>
                                <input type="text" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" value="<?php echo $row['coupon_name']?>"
                                    name="coupon_name">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Discount</label>
                                <input type="text" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" value="<?php echo $row['discount']?>" name="discount">
                            </div>
