...
$result=mysqli_query($connection, $sql);
    foreach ($result as $row) {?>
                <div class="table-wrapper">
                    <form method="post" action="brand_controller.php?action=edit" enctype="multipart/form-data">
                        <div class=" modal-body pd-20">

                            <div class="form-group">
                                <input type="hidden" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" value="<?php echo $row['b_id']?>" name="b_id">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Brand Name</label>
                                <input type="text" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" value="<?php echo $row['b_name']?>" name="b_name">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Brand Logo</label>
                                <input type="file" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" value="../../media/brands/<?php echo $row['b_logo']?>"
                                    name="b_logo">
                                <img title="old Logo" src="../../media/brands/<?php echo $row['b_logo']?>" alt=""
