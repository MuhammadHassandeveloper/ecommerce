                    ...
                    <table id="datatable1" class="table display responsive nowrap">
                        ...
                        <tbody>
                            <?php
                                    ...
                                    $page=$page-1;
$sql="SELECT * FROM brands limit $page,4";
$result=mysqli_query($connection, $sql);
    foreach ($result as $row) {?>

                            <td><?php echo $row['b_id']?></td>
                            <td><?php echo $row['b_name']?></td>
                            <td><img src="../../media/brands/<?php echo $row['b_logo']?>"
                                    style="width:50px;height:70px;"> </td>
                            <td> <a href="edit.php?id=<?php echo $row['b_id']?>" class="btn btn-sm btn-info">Edit</a>
                                <a href="brand_controller.php?action=delete&id=<?php echo $row['b_id']?>"
