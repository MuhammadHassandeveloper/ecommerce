            ...
            <div class="table-wrapper">
                <table id="datatable1" class="table display responsive nowrap">
                    ...
                    <tbody>
                        ...
                        <?php
                        $sql = "SELECT users.*,shipping.*,orders.* FROM ((users INNER JOIN shipping ON users.u_id=shipping.u_id) INNER JOIN orders ON users.u_id=orders.u_id)";
                        ...
                        foreach ($result as $row) { ?>
                            ...
                            <td>
                                ...
                                <?php } elseif ($row['order_status'] == 2) { ?>
                                    <span style='color:white; background:green;padding:5px;'> Process </span>
