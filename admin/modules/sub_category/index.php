    ...
    <div class="sl-mainpanel">
        ...
        <div class="sl-pagebody">
            <div class="sl-page-title">
                <h5>Sub_Category Table</h5>
            </div><!-- sl-page-title -->

            <div class="card pd-20 pd-sm-40">
                <h6 class="card-body-title">Sub_Category List
                    <!----------------------- success msg ---------------------------->
                    <?php
            ...
            <div class="table-wrapper">
                <table id="datatable1" class="table display responsive nowrap">
                    <thead>
                        <tr>
                            <th class="wd-15p">Sub_catgory Id</th>
                    ...
                    <tbody>
                        <?php
                            ...
                            $page=$page-1;
$sql="SELECT categories.cat_name,sub_categories.* FROM categories INNER JOIN sub_categories ON categories.cat_id=sub_categories.cat_id limit $page,5";
$result=mysqli_query($connection, $sql);
    foreach ($result as $row) {?>
                        ...
                        <td> <a href="edit.php?id=<?php echo $row['sub_id']?>" class="btn btn-sm btn-info">Edit</a>
                            <a href="sub_category_controller.php?action=delete&id=<?php echo $row['sub_id']?>"
                ...
                <ul class="pagination pagination-lg justify-content-end" style="margin:2px 0">
                    <?php
                                global $connection;
                                    ...
                                    $limit=ceil(mysqli_num_rows($results)/5);
                                    for ($i=1;$i<=$limit;$i++) {
                                        ?>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content tx-size-sm">
                    <div class="modal-header pd-x-20">
                        <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Add Sub_category</h6>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>

                    <form method="POST" action="sub_category_controller.php?action=add">
                        <div class="modal-body pd-20">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Sub_Category Name</label>
                                <input type="text" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" placeholder="Category" name="sub_name">
                            </div>
                            <div class="form-group">
