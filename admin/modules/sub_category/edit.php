    ...
    <div class="sl-mainpanel">
        ...
        <div class="sl-pagebody">
            <div class="sl-page-title">
                <h5>Sub_Category Update</h5>

            </div><!-- sl-page-title -->

            <div class="card pd-20 pd-sm-40">
                <h6 class="card-body-title">Sub_Category Update
...
$result=mysqli_query($connection, $sql);
    foreach ($result as $row) {?>
                <div class="table-wrapper">
                    <form method="post" action="sub_category_controller.php?action=edit">
                        <div class="modal-body pd-20">

                            <div class="form-group">
                                <input type="hidden" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" value="<?php echo $row['sub_id']?>" name="sub_id">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Sub_Category Name</label>
                                <input type="text" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" value="<?php echo $row['sub_name']?>" name="sub_name">
                            </div>
                            <div class="col-lg-12">
