                                        ...
                                        <div class="cart_container">
                                            ...
                                            <div class="cart_items">
                                                <ul class="cart_list">
                                                    ...
                                                    <?php
                                                        array_push($cart_items, array("pro_id" => $row["p_id"], "pro_name" => $row["pro_name"], "color" => $row['pro_color'], "size" => $row['pro_size'], "quantity" => $row['no_of_products'], "price" => $row['selling_price'], "total" => $row['selling_price'] * $row['no_of_products']));
                                                        $count++;
                                                    } ?>
                                                </ul>
                                            </div>
